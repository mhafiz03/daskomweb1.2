  ...
  <div class="bg-green-900 w-full h-full overflow-hidden">
    ...
    { 'right-min20rem': !pageActive }]" @mouseover="isMenuShown = false">
      ...
      { 'rounded-tl-large': !changePage || !menuProfil }]" ref="menuRef">
        ...
        <div class="w-full p-4 h-24 flex select-none cursor-pointer hover:text-white animation-enable" :class="[{ 'bg-yellow-400 hover:bg-yellow-600': !changePage || !menuLihatTp },
        { 'bg-yellow-500 text-white': changePage && menuLihatTp }]" v-on:click='travel("lihat_tp")'>
          <div class="w-7/12 my-2 flex">
            <div class="w-4/6" />
